  ...
  return (
    <div className="wrapper clear">
      ...
      <div className="card mr-40">
          <img className="mb-15" width={133} height={112} src="/img/sneakers/1.jpg"/>
        ...
        <div className="card mr-40">
          <img className="mb-15" width={133} height={112} src="/img/sneakers/2.jpg"/>
          <h5 className="mb-15">Мужские Кроссовки Nike Blazer Mid Suede</h5>
          <div className="cardBottom d-flex justify-between align-center">
            <div className="d-flex flex-column">
              <span>Цена:</span>
        ...
        <div className="card mr-40">
          <img className="mb-15" width={133} height={112} src="/img/sneakers/3.jpg"/>
          <h5 className="mb-15">Мужские Кроссовки Nike Blazer Mid Suede</h5>
          <div className="cardBottom d-flex justify-between align-center">
            <div className="d-flex flex-column">
              <span>Цена:</span>
        ...
        <div className="card">
          <img className="mb-15" width={133} height={112} src="/img/sneakers/4.jpg"/>
          <h5 className="mb-15">Мужские Кроссовки Nike Blazer Mid Suede</h5>
          <div className="cardBottom d-flex justify-between align-center">
            <div className="d-flex flex-column">
              <span>Цена:</span>
